...
{
    public class ComandoRestaFraccionarios : ComandoBase<KeyValuePair<int, int>>
    {
        public ComandoRestaFraccionarios(KeyValuePair<int, int> valor, Calculadora<KeyValuePair<int, int>> calculadora) : base(valor, calculadora)
        {
        }
